...
// systemPrompt is the specialised prompt that defines the agent's behaviour.
const marketAgentSystemPrompt = `Tu es l'Agent 📊 Marché — un analyste technique financier spécialisé.
